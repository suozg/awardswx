...
class ComboSearchHelper:
    ...
    def _perform_search_and_update(self):
        ...
        if not current_text:
            ...
            # Фільтруємо за ПОЧАТКОМ рядка (номер подання на початку)
            # або за входженням тексту
        ...
        # Перевіряємо, чи поточний текст є одним із елементів у відфільтрованому списку
